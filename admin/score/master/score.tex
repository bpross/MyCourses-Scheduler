...
Our database holds two different tables; a table that the program administrator modifies, and a table that The Scheduler outputs to.
	...
	The table that the scheduler outputs to holds a complete quarter schedule, along with a list of the students signed up for the classes within the schedule. Additionally, this table holds past schedules and records of the students that were enrolled in the courses to keep a record of which student has taken which class.  
