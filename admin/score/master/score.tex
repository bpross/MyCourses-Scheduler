...
The novelty of our project lies in its ability to define the constraints of courses, classrooms and professors. By offering this amount of flexibility, we can reduce the overhead cost and time necessary to schedule courses. Below we outline a common scenario for each category of users. 
\subsection{Scenario 1}
In this scenario, we will outline the initial role of the Program Administrator who, similar to a Registrar, will be adding a course to the system.
...
\item	Choosing to import data, the Program Administrator will need to provide the following: 
	...
	\item	A list of all classrooms and buildings available, including...
		\begin{enumerate}	
		\item Room capacity
		\item Subject preference (Social Sciences belong in the Sociology building)
		\end{enumerate}
	\item	List of all the day slots (e.g. Can classes be taught on Saturday?)
	\item	List of time slots (e.g. 8am to 10pm, but not 12pm to 1pm)
