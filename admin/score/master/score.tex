...
The overall system was broken down into three main parts: the web interface, the database, the scheduler. Our implementation strategy was to find the best way to implement these parts separately, and then collectively integrate them.
